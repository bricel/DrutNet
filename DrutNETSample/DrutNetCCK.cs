...
namespace DrutNet
{
    public class CCK : SimplePDMConnection
    {
        ...
        /// </summary>
        public List<CCK> ContentRef
        {
            get { return _contentRef; }
            set { _contentRef = value; }
        }
        List<CCK> _contentRef = new List<CCK>();
        /// <summary>
        ...
        public CCK(Enums.ContentType getContent_type, User user)
            : base()
        {
        ...
        public CCK(Enums.ContentType getContent_type, User user,string contentFile)
        ...
        {
            if (  (DrutNETBase.FileExists(contFile)) &&  ((overwriteThumb) ||
                     ((_imagefile == "")&& (_httpImagePath == "")))) //case no thumb
            {
                ...
                try
                {
                    ...
                    thumbFN = DrutNETBase.GetUniqueFileName(Enums.TEMPSAVEFOLDER +
                            DrutNETBase.GetFileNameWithoutExtension(contFile) + ".jpg");
        ...
        protected bool CurlWriteContentData(MultiPartForm mf, string url, bool uploadContentFile, bool asNew)
        {
            ...
            int i = 0;
            //content reference
            foreach (CCK refID in _contentRef)//objects
            {
                if (refID.NodeID != -1)
        ...
        private string CurlDrupalFormErrorsFile()
        {
            ...
            //}
            //return retMsg;
            string filename = DrutNETBase.GetUniqueFileName(Enums.TEMPSAVEFOLDER + this.NodeID + ".html");
                            ...
                            { //get file id for revison conmpare later
                                ...
                                if (saveFileLocaly)
                                {
                                   ...
                                   (_contentFileNode[0] as XmlRpcStruct)).Replace(Enums.FILEFOLDER, "");
                                    ...
                                    DrutNETBase.CreateDir(localSaveFolder);
                                    ContentFile = localSaveFolder + fileName;

                                    if (DrutNETBase.FileExists(ContentFile))
                                    {   //display overwrite warning
                                        ...
                                        if (backupIfExist)//backup overwited file to temp folder
                                        {
                                            ...
                                            DrutNETBase.CreateDir(backupDir);
                                            File.Copy(ContentFile, DrutNETBase.GetUniqueFileName(backupDir + fileName));
                                        }
                                    }
        ...
        static public List<CCK> SearchContent(string contentTitle, OrganicGroup organicGroupRef,
            Enums.ContentType contentType, User user)
        {
            List<CCK> res = new List<CCK>();
                        ...
                        try
                        {
                            ...
                            if (currentConType != Enums.ContentType.Undefined)
                            {
                                ...
                                {//check if content type is of the asked type
                                    CCK temp = new CCK(contentType, user);
    ...
    public class SimplePDMCadContent : CCK
    {
       ...
       // Enums.TaskStatus _cadConvertTaskStatus = Enums.TaskStatus.Null;
        ...
        public SimplePDMCadContent(Enums.ContentType conType,User user)
            : base(conType, user)
        {
        }
        #region Load XML-RPC
    ...
    public class SimplePDMStyle : SimplePDMCadContent
    {
      ...
      /* public Enums.TaskStatus GetMeasurmentTaskStatus { get { return _getMeasurmentTaskStatus; } set { _getMeasurmentTaskStatus = value; } }
       ...
       // Enums.StyleType _styleType = Enums.StyleType.RegularStyle;//default
        ...
        #region Constructors
        public SimplePDMStyle(User user)
            : base(Enums.ContentType.Style, user)
        {
        }
        public SimplePDMStyle(User user, string getLocalFilePath, string getTitle)
            : this(user)
        {
            Title = getTitle;
        ...
        /// </summary>
        static public bool UploadMTMZip(string styleTitle, string zipFullPath, string tempUnZipFolder, User author)
        {
        ...
        static public bool UploadMTMZip(string styleTitle, string zipFullPath, string tempUnZipFolder,
            User author, Enums.ProductionState productionState, string styleFile, bool mtm)
        {
            DrutNETBase.UnZip(zipFullPath, tempUnZipFolder);
    ...
    public class SimplePDMMarker : SimplePDMCadContent
    {
        ...
        #region Constructors
        public SimplePDMMarker(User user)
            : base(Enums.ContentType.Marker, user)
        {  }
        public SimplePDMMarker(User user, string getLocalFilePath, string getTitle)
            : this(user)
        {
            Title = getTitle;
            ContentFile = getLocalFilePath;
    ...
    public class SimplePDMImage : CCK
    {
        public SimplePDMImage(User user)
