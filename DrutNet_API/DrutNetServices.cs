...
namespace SimplePDM
{
 ...
 //   [XmlRpcUrl("http://192.168.1.2/simplepdm/services/xmlrpc")]
   // [XmlRpcUrl(Enums.SERVERURL + "services/xmlrpc" + Enums.SERVERURLDEB)]//moved to URL property
    ...
    //----------------------------------------------------------------------------------------------------------
    /// <summary>
    /// enable to connect to drupal services using XML RPC -- Single Tone --
    /// </summary>
    public class DrupalServices : SimplePDM.BaseSimplePDM
    {
        //Statics
        
        static DrupalServices singleInstance;
        //privates                                                      
        ...
        public static DrupalServices GetInstance()
        {
            if (singleInstance == null)
                return (singleInstance = new DrupalServices());
            else
            {
                if (!singleInstance.LoggedIn)
                    singleInstance.errorMessage("Services is not connected");
        ...
        {
            sendLogEvent(msg, Enums.MessageSender.Services, Enums.MessageType.Error);
        }
        ...
        public bool Login(string user, string password)
        {
            try
            {
                ...
                drupalServiceSystem.Url = Enums.SERVERURL + "services/xmlrpc" + Enums.SERVERURLDEB;
