...
namespace SeasideResearch.LibCurlNet
{
    ...
    public enum CURLoption
    {
        ...
        /// querying command. The -"Easy.GetInfo" function with the
        ...
        /// subsequently be retrieved using Easy.GetInfo with the
    ...
    /// - "Easy.GetInfo - specifying the item to retrieve in the
